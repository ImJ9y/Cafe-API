...
def get_random_cafe():
    ...
    # You can use to_dict() here too instead of manually building the dictionary
    return jsonify(cafe=random_cafe.to_dict())


# HTTP POST - Create Record
@app.route("/add", methods=["POST"])
def create_random_cafe():
    new_cafe = Cafe(
        name=request.form.get("name"),
        map_url=request.form.get("map_url"),
        img_url=request.form.get("img_url"),
        location=request.form.get("loc"),
        has_sockets=request.form.get("sockets") == "true",  # Better boolean conversion
...
def update_price(cafe_id):
    ...
    cafe = db.session.get(Cafe, cafe_id)  # Updated to use new SQLAlchemy syntax
    if cafe:
